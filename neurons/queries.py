...
from neurons.apify.tweeter.web_harvester_twitter_scraper_query import (
    WebHarvesterTwitterScraperQuery,
)
...
QUERY_MAP = {
    ...
    (
        QueryType.TWITTER,
        QueryProvider.WEB_HARVESTER_TWITTER_SCRAPER,
    ): WebHarvesterTwitterScraperQuery,
    (
        QueryType.TWITTER,
        QueryProvider.MICROWORLDS_TWITTER_SCRAPER,
